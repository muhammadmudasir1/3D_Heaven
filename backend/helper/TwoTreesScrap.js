...
const TwoTreesScrap = async (url) => {
        ...
        let discountedPriceSelector='.price--medium .price__sale .price__last .price-item--sale ';
        let regularPriceSelector='.price--medium .price__sale .price__compare .price-item--regular ';
        let discountedPrice=""
        let regularPrice=""
